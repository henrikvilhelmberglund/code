...
let lagBInputField = document.querySelector("#lag-b-input-field");
let lagAAddPlayerButton = document.querySelector("#lag-a-ad-player-button");
let lagBAddPlayerButton = document.querySelector("#lag-a-ad-player-button");
