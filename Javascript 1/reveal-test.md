...
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/black.css'); return false;">Black (default)</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/white.css'); return false;">White</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/league.css'); return false;">League</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/sky.css'); return false;">Sky</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/beige.css'); return false;">Beige</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/simple.css'); return false;">Simple</a> <br>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/serif.css'); return false;">Serif</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/blood.css'); return false;">Blood</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/night.css'); return false;">Night</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/moon.css'); return false;">Moon</a> -
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/solarized.css'); return false;">Solarized</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/cern.css'); return false;">Cern</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/material.css'); return false;">Material</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/myplanet.css'); return false;">My Planet</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/object-partners.css'); return false;">Object partners</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/pikestreet.css'); return false;">Pikestreet</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/puzzle.css'); return false;">Puzzle</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/robot-lung.css'); return false;">Robot lung</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/robot-lung-ebi.css'); return false;">Robot lung ebi</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/savasian.css'); return false;">Savasian</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/sfeir-school.css'); return false;">Sfeir school</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/sunblind.css'); return false;">Sunblind</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/tidy.css'); return false;">Tidy</a>
<a href="#" onclick="document.getElementById('theme').setAttribute('href','libs/reveal.js/4.3.1/theme/hull-blue.css'); return false;">Hull blue</a>
